package cn.loveapp.doudianyun.consumer;
...
public class DoudianyunConsumerApplication {

    public static void main(String[] args) {
        initProfiles();
        defaultProfile();
        saveProfile();
        SpringApplication app = new SpringApplication(DoudianyunConsumerApplication.class);
        app.run(args);
    }
